...
from utils.math_utils import meters_to_rotations, rps_to_mps, mps_to_rps, rps_to_rpm
...
class DrivetrainSim:
    ...
    def execute(self, tm_diff: float) -> None:
        ...
        self.diff_drive_sim.setInputs(
            self.left_gearbox_sim.getSetpoint() * RobotConst.NOMINAL_VOLTAGE,
            self.right_gearbox_sim.getSetpoint() * RobotConst.NOMINAL_VOLTAGE,
        )
