...
class RobotConst:
    ...
    NOMINAL_VOLTAGE: volts = 12.0 # Estimate voltage for the battery
...
class ArmVelocityPID:
    # Arm velocity PID (input in radps, output in volts - estimates)
    KP = 0.01
    KI = 0.0
    KD = 0.0
...
class ArmPositionPID:
    # Arm position PID (input in radps, output in volts - estimates)
    KP = 0.01
    KI = 0.0
    KD = 0.0
