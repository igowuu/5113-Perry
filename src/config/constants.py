...
class RobotConst:
    ...
    NOMINAL_VOLTAGE: volts = 12.0 # Estimated voltage for the battery
...
# Drivetrain PID
class DrivetrainPID:
    # Left gearbox PID (input in m/s, output in volts - defaults, untuned)
    LEFT_KP = 0.01
    LEFT_KI = 0.0
    LEFT_KD = 0.0

    # Right gearbox PID (input in m/s, output in volts - defaults, untuned)
    RIGHT_KP = 0.01
    RIGHT_KI = 0.0
    RIGHT_KD = 0.0
...
class DrivetrainFF:
    ...
    LEFT_KS: volts = 0.50
    LEFT_KV: volt_seconds_per_meter = 2.60
    LEFT_KA: volt_seconds_squared_per_meter = 0.05

    # Right gearbox feedforward (estimates)
    RIGHT_KS: volts = 0.50
    RIGHT_KV: volt_seconds_per_meter = 2.60
    RIGHT_KA: volt_seconds_squared_per_meter = 0.05
