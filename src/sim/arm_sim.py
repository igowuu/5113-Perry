...
class ArmSim:
    """
    This class simulates the predicted arm movement given input from the actual Arm subsystem.
    It uses declared constants in the config file to module physics.
    """
    ...
    def execute(self, tm_diff: seconds) -> None:
        ...
        """
        self.arm_sim.setInput(0, self.arm_left_motor_sim.getMotorOutputLeadVoltage()) # type: ignore
