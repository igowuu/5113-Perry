...
class PhysicsEngine:
    """
    This class, managed by pyFRC, orchestrates and executes all simulated subsystems of the robot.

    By design, all simulated subsystems to not inherit from AdaptiveComponent since they are already
    managed by by pyFRC scheduler.
    """
